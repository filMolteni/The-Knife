...
public class app {
    ...
    public static void main(String[] args) {
            ...
            if (logged == null) { 
                ...
                break;
                    ...
                    case "2":
                        ...
                        if (!trovata) {
                            System.out.println("Nessuna recensione anonima trovata o ristorante non esistente per la ricerca: \"" + nomeRistorante + "\".");
                        }
                    ...
                    while (dataNascita == null) {
                        try {
                            ...
                            System.out.println("Formato data non valido. Riprova con il formato yyyy-mm-dd.");
                        }
                    }
                    ...
                    while (true) {
                        ...
                        if (domicilio.matches("[a-zA-Z\\s]+")) {
                            ...
                            System.out.println("Il domicilio può contenere solo lettere e spazi. Riprova.");
                        }
                    }
                    ...
                    while (!inputValido) {
                        try {
                            ...
                            if (!ruolo.equals("0") && !ruolo.equals("1")) {
                                throw new IllegalArgumentException();
                            }
                            isCliente = ruolo.equals("0");
                            inputValido = true;
                        } catch (IllegalArgumentException e) {
                            System.out.println("Scelta non valida. Inserisci 0 per Cliente o 1 per Ristoratore.");
                        }
                    }
        ...
        System.out.println(" Registrazione completata con successo!");
                    ...
                    try {
                        scelta = sc.nextInt();
                        sc.nextLine(); // consuma newline residuo
                    } catch (InputMismatchException e) {
                        System.out.println("Input non valido. Inserisci un numero intero.");
                        sc.nextLine(); // pulisce il buffer in caso di errore
                    }
                        ...
                        while (true) {
                            ...
                            try {
                                ...
                                if (voto >= 1 && voto <= 5) {
                                    ...
                                    System.out.println("Il voto deve essere un numero tra 1 e 5.");
                                }
                            } catch (NumberFormatException e) {
                                System.out.println("Input non valido. Inserisci un numero intero tra 1 e 5.");
                            }
                        }
                ...
                System.out.println("[3] Visualizza statistiche dei tuoi ristoranti");
                System.out.println("[4] Logout");
                System.out.println("[5] Visualizza tutti i ristoranti");
                System.out.println("[6] Ricerca ristorante");
                ...
                break;
                    ...
                    int sceltaRistoratore = -1;
                    try {
                        sceltaRistoratore = sc.nextInt();
                        sc.nextLine(); // consuma newline residuo
                    } catch (InputMismatchException e) {
                        System.out.println("Input non valido. Inserisci un numero intero.");
                        sc.nextLine(); // pulisce il buffer in caso di errore
